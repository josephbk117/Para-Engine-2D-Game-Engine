...
int main(int, char**)
{
	...
	ImFont* font = io.Fonts->AddFontFromFileTTF("Test Resources\\arial.ttf", 24.0f);
	IM_ASSERT(font != NULL);
...
void StyleColorsParaEngineDefault(ImGuiStyle* dst)
{
	...
	colors[ImGuiCol_Text] = ImVec4(0.58f, 0.2f, 0.35f, 1.00f);
	...
	colors[ImGuiCol_WindowBg] = ImVec4(0.64f, 0.54f, 0.64f, 1.00f);
	colors[ImGuiCol_ChildBg] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
	colors[ImGuiCol_PopupBg] = ImVec4(0.7f, 0.8f, 1.00f, 0.78f);
	colors[ImGuiCol_Border] = ImVec4(0.00f, 0.00f, 0.00f, 0.90f);
	colors[ImGuiCol_BorderShadow] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
	colors[ImGuiCol_FrameBg] = ImVec4(0.84f, 0.84f, 0.74f, 1.00f);
	...
	colors[ImGuiCol_TitleBg] = ImVec4(0.56f, 0.26f, 0.46f, 1.00f);
	colors[ImGuiCol_TitleBgActive] = ImVec4(0.56f, 0.30f, 0.56f, 1.00f);
	...
	colors[ImGuiCol_ResizeGrip] = ImVec4(0.90f, 0.30f, 0.90f, 0.76f);
